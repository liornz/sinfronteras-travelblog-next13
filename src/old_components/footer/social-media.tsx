...
const SocialMedia: React.FC = () => {
  return (
    <div className={styles.container}>
      ...
      <a id="instagram" className={styles.item} href="https://www.instagram.com/alalufvictor.sinfronteras/">
        <SiInstagram color="#833AB4" size="1.5rem" />
        <p className={styles.social_text}>INSTAGRAM</p>
      </a>
      <a id="youtube" className={styles.item} href="https://www.youtube.com/channel/UCWeBug5IyKmZq81ulHUKwkg">
        <FaYoutubeSquare color="#FF0000" size="1.5rem" />
        <p className={styles.social_text}>YOUTUBE</p>
      </a>
      <a id="victoralaluf" className={styles.item} href="https://victoralaluf.com" target="_blank" rel="noreferrer">
